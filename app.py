...
st.markdown(
    ...
    .chat-history {
        ...
        max-height: 400px; /* Increase height for more visible messages */
...
st.image("C:/Users/Lenovo/OneDrive - Alexandria University/Desktop/maids_chatbot/logo.png", width=150)
...
# User input
user_input = st.text_input("Type your message here:", key="user_input", on_change=process_input)
